...
from workflow_agents.base_agent import KnowledgeAugmentedPromptAgent, RoutingAgent
import os
...
print(routing_agent.respond("Tell me about the history of Rome, Texas"))
print(routing_agent.respond("Tell me about the history of Rome, Italy"))
print(routing_agent.respond("One story takes 2 days, and there are 20 stories"))
