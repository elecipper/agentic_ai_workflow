...
from workflow_agents.base_agent import ActionPlanningAgent
import os
...
planning_agent = ActionPlanningAgent(openai_api_key=openai_api_key, knowledge=knowledge)
...
planning_agent_response = planning_agent.respond(prompt)

print(planning_agent_response)
